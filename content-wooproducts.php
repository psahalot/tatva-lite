...
if (class_exists('woocommerce')) {
    ...
    if (get_theme_mod('tatva_woo_front_featured_products')) {
        ?>

        <div id="home-product-container">

            <div class="home-products" role="main">

                <div class="col grid_12_of_12">
                        <?php if (get_theme_mod('tatva_woo_front_featured_title')) : ?>
                        <h3 class="featured-edd-title">
                        <?php echo (get_theme_mod('tatva_woo_front_featured_title')); ?>
                        </h3>   
                    <?php endif; ?>

                    <?php
                    $per_page = intval(get_theme_mod('tatva_woo_store_front_count'));
                    $product_args = array(
                        'post_type' => 'product',
                ...
                <?php the_post_thumbnail('product-image-thumb'); ?>
                                    ...
                                    <div class="home-product-info">
                                            ...
                                            <div class="product-buttons">
                                                ...
                                                <a href="<?php the_permalink(); ?>" class="product-details-link"><?php esc_html_e('View Details', 'tatva'); ?></a>
        ...
        <?php endif; ?>
                ...
                <p class="tatva-store-button"><a class="cta-button" href="<?php echo esc_url(get_theme_mod('tatva_woo_store_link_url')); ?>"><?php echo esc_html(get_theme_mod('tatva_woo_store_link_text')); ?></a></p>
